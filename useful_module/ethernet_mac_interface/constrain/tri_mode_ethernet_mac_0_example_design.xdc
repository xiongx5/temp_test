...
############################################################
set_property IODELAY_GROUP tri_mode_ethernet_mac_iodelay_grp [get_cells -hier tri_mode_ethernet_mac_idelayctrl_common_i]
...
set_property CLOCK_DEDICATED_ROUTE BACKBONE [get_nets -of [get_pins -hier -filter {name =~ *example_clocks/clkin1_buf/O}]]
...
#get_cells -hier -filter {name =~ pause_req*}
